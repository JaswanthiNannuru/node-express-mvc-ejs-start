...
## Overview
- This app basically shows all the files that are created and needed for the changes asked us to do.
## Team
- Jaswanthi Nannuru is the 'User' developer
- Rahul Mallampati is the 'Acounts' developer
- Sunil Mundru is the 'Transactions' developer
- We worked on the above files to set their attributes and to make them work. 
